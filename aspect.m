...
% parameters
cases = [2, 3, 5, 10, 15, 30, 60, 90, 180, 300, 450];
nmax = 20000;
tol = 10 ^ -10;
...
% save cputime result
loglog(cases, ctimes', cases, ptimes', cases, ebetimes', cases, ebecgtimes', cases, ebetimes' - ebecgtimes');
legend('CG method', 'PCG method', 'PCG with EBE', 'EBE without P', 'EBE');
title("calculation time");
ylabel("calculation time");
xlabel("width");
legend("location", "northwest");
print("cputime-a.png", "-dpng")
csvwrite("cputime-a.csv", [cases', ctimes', ptimes', ebetimes', ebecgtimes'])

% save iterations result
plot(cases, citers', cases, piters', cases, ebeiters');
legend('CG method', 'PCG method', 'PCG with EBE');
title("count of iteration");
ylabel("iterations");
xlabel("width");
legend("location", "northwest");
print("iterations-a.png", "-dpng")
csvwrite("iterations-a.csv", [cases', citers', piters', ebeiters'])
...
ylabel("error");
xlabel("iteration");
print("errors-a.png", "-dpng")
csvwrite("errors-a.csv", [(1:maxn)', cerrors(end, 1:maxn)', perrors(end, 1:maxn)', ebeerrors(end, 1:maxn)'])
